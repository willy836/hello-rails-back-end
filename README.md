...
**[Hello Rails Back-end]** is a simple rails back-end project that returns a random greeting. The goal of this project is implementing a Ruby on Rails API that can be consumed by a front-end app.
...
- git clone https://github.com/willy836/hello-rails-back-end.git
...
Feel free to check the [issues page](https://github.com/willy836/hello-rails-back-end/issues).
